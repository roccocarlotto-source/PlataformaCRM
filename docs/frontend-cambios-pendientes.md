...
**Backend: 892 unitarios, todos en verde** (antes del ítem, contra `master` sin el ítem 70: 887). Neto +5, porque además de los que se agregaron se fueron dos que probaban código borrado.
...
**Frontend: 156 archivos, 1667 casos, todos en verde** (antes del ítem, contra `master` sin el ítem 70: 156 archivos, 1664). Ningún archivo nuevo.
