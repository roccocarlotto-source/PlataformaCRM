...
from (
  ...
  from (values
    ...
    -- Brief de cada conversación (ítem 73, migración 20260927120000): quién
    -- CORRIGIÓ A MANO el resumen que redactó la IA. Es la segunda FK de
    -- conversations hacia users, y el caso que esta fila existe para atrapar
    -- está acá más a mano que en ningún lado: conversations.contact_id apunta
