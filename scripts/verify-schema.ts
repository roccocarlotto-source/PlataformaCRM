...
const ESPERADO_EXACTO = new Map<number, ChequeoAfirmado>([
  ...
  [8, { descripcion: "Los 24 CHECK constraints, por pg_get_constraintdef", esperado: "ninguno" }],
  ...
  [
    11,
    {
      descripcion: "ALTO-6 · los 7 índices (organization_id, deleted_at, created_at)",
      esperado: "ninguno",
    },
  ],
  [
  ...
  [
    16,
    {
      descripcion: "C-3 · las 51 FKs conocidas siguen apuntando a la tabla padre de su diseño",
      esperado: "ninguna",
    },
  ],
